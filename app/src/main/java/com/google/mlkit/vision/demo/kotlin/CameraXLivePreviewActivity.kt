...
class CameraXLivePreviewActivity :
    ...
    private lateinit var list: Catalog
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        listButton = findViewById<Button>(R.id.list_button)
        ...
        // Getting the catalog instance
        list = (application as MyApplication).list
    ...
    /**
     * Control when the View List button is visible
     */
    fun onListCreated() {
        if (list.getAllItems() != null) {
                ...
                try {
                    when (selectedModel) {
                        OBJECT_DETECTION -> {
                            ...
                            ObjectDetectorProcessor(this, objectDetectorOptions, Catalog(), { onListCreated() })
                        }
                        OBJECT_DETECTION_CUSTOM -> {
                            ...
                            ObjectDetectorProcessor(this, customObjectDetectorOptions, Catalog(), { onListCreated() })
                        }
